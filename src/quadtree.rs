...
const CQT_MAX_OBJECTS_PER_NODE: usize = 256;
const CQT_MAX_LEVELS: i32 = 4;
...
impl CollisionQuadtree {
    ...
    pub fn spawn(x: f32, y: f32, w: f32, h: f32) -> Self {
        Self::new(0, Rectangle2D {x: x, y: y, width: w, height: h } )
    }
